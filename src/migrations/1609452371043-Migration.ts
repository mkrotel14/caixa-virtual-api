...
export class Migration1609452371043 implements MigrationInterface {
    name = 'Migration1609452371043'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "transactions_category_enum" AS ENUM('Incoming', 'Outgoing')`);
